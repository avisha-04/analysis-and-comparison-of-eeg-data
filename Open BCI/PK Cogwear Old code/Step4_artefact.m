...
artefact_tracker =zeros(length(files), 4);
...
for k = 1:length(files)
    ...
    %EEG = pop_importdata('dataformat','ascii','nbchan',0,'data','C:\\Users\\yangg\\Documents\\PK Cogwear\\EEG_openBCI\\OpenBCI-RAW-2019-06-13_16-39-24.txt','srate',200,'pnts',0,'xmin',0,'chanlocs','C:\\Users\\yangg\\Documents\\PK Cogwear\\cogwear_chanloc_04.ced');
